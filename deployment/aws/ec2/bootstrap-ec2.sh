...
echo "  2. Ensure glo.GloCredential has Global:DATABASE (FgsUser, FgsAudit, FgsNotification, FgsSetup, FgsInventory, …),"
...
echo "     redis → rabbitmq → setup → audit → user → bff → notification → file → inventory → consumer → nginx"
