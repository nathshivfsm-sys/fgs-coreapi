...
echo "  2. Ensure glo.GloCredential has Global:DATABASE:FgsUser, Global:REDIS, Global:RABBITMQ, Global:DATADOG, etc."
...
echo "  7. First full stack (after images in ECR): deploy redis → rabbitmq → setup → user → bff → nginx"
