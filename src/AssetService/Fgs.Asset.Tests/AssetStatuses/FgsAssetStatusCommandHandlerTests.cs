...
public sealed class FgsAssetStatusCommandHandlerTests
{
    ...
    private static FgsAssetStatusWriteService CreateWriteService(FgsAssetDbContext context)
    {
        ...
        return new FgsAssetStatusWriteService(context, new EfUnitOfWork<FgsAssetDbContext>(context), auditHelper);
    }
