...
internal sealed class InventoryOutboxMessageConfiguration : IEntityTypeConfiguration<InventoryOutboxMessage>
{
    public void Configure(EntityTypeBuilder<InventoryOutboxMessage> entity)
    {
        entity.ToTable("InventoryOutboxMessage");
