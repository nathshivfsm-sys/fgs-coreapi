...
internal sealed class FgsInventoryItemConfiguration : IEntityTypeConfiguration<FgsInventoryItem>
{
    public void Configure(EntityTypeBuilder<FgsInventoryItem> entity)
    {
        ...
        entity.HasIndex(e => new { e.TenantId, e.CompanyId, e.InventoryItemTypeId, e.InventorySubCategoryId })
