-- =============================================================================
-- Migration: 20260519155306_AlignGloCatalogModel
-- Idempotently ensures Glo catalog unique/check constraints and column defaults
-- match the EF model (UX_GloRole_RoleCode, UQ_GloSetupDescriptionType_Code, etc.).
-- Does not drop existing named constraints.
-- Script:   Database/Scripts/20260519155306_AlignGloCatalogModel_Up.sql
-- Pair with: Database/Migrations/20260519155306_AlignGloCatalogModel.cs
-- Run after 20260519120000_GloCatalogConstraints when the database predates that script.
-- =============================================================================
...
VALUES ('20260519155306_AlignGloCatalogModel', '10.0.8')
