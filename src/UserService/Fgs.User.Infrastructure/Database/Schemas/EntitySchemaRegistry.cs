...
internal static class EntitySchemaRegistry
{
    ...
    private static Dictionary<string, string> BuildTableSchemas() => new()
    {
        ...
        ["FgsTenantMenu"] = FgsDatabaseSchemas.Identity,
        ["FgsRoleMenu"] = FgsDatabaseSchemas.Identity,
        ...
        ["FgsPublicEndpoint"] = FgsDatabaseSchemas.Identity,
    ...
    private static Dictionary<Type, string> BuildEntitySchemas() => new()
    {
        ...
        [typeof(FgsTenantMenu)] = FgsDatabaseSchemas.Identity,
        [typeof(FgsRoleMenu)] = FgsDatabaseSchemas.Identity,
        ...
        [typeof(FgsPublicEndpoint)] = FgsDatabaseSchemas.Identity,
