...
internal sealed class TenantOutboxMessageConfiguration : IEntityTypeConfiguration<TenantOutboxMessage>
{
    public void Configure(EntityTypeBuilder<TenantOutboxMessage> entity)
    {
        entity.ToTable("TenantOutboxMessage");
