...
namespace Fgs.User.Infrastructure.Persistence.Database.Migrations
{
    ...
    partial class AddGloUnitOfMeasureGloTagFgsTagGloTitleOfCourtesy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fgs.User.Domain.Entities.GloCategory", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
                    ...
                    b.ToTable("GloCategory", "dbo", t =>
                        {
                            t.HasCheckConstraint("CK_GloCategory_Code_Upper", "\"Code\" = upper(\"Code\")");
                        });
                });

            modelBuilder.Entity("Fgs.User.Domain.Entities.GloCategorySubCategory", b =>
                {
                    b.Property<int>("BusinessTypeId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("BusinessTypeId", "CategoryId", "SubCategoryId");

                    b.HasIndex("CategoryId");

                    b.HasIndex("SubCategoryId");

                    b.ToTable("GloCategorySubCategory", "dbo");
                });
            ...
            modelBuilder.Entity("Fgs.User.Domain.Entities.GloSubCategory", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
                    ...
                    b.ToTable("GloSubCategory", "dbo", t =>
                        {
                            t.HasCheckConstraint("CK_GloSubCategory_Code_Upper", "\"Code\" = upper(\"Code\")");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.User.Domain.Entities.GloCategorySubCategory", b =>
                {
                    ...
                    b.HasOne("Fgs.User.Domain.Entities.GloCategory", null)
                        .WithMany()
                    ...
                    b.HasOne("Fgs.User.Domain.Entities.GloSubCategory", null)
                        .WithMany()
