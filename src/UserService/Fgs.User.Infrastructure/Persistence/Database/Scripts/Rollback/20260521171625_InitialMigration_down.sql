...
-- Script:   20260521171625_InitialMigration_down.sql
-- Path:     Persistence/Database/Scripts/Rollback
-- Database: PostgreSQL (schema: dbo)
--
-- Reverts InitialMigration (drops all tables created by the up script).
...
DO $EF$
BEGIN
    IF EXISTS(SELECT 1 FROM dbo."__EFMigrationsHistory" WHERE "MigrationId" = '20260521171625_InitialMigration') THEN
...
BEGIN
    IF EXISTS(SELECT 1 FROM dbo."__EFMigrationsHistory" WHERE "MigrationId" = '20260521171625_InitialMigration') THEN
    DROP TABLE dbo."FgsSetupPricingMatrixLaborTier";
    END IF;
END $EF$;
DO $EF$
BEGIN
    IF EXISTS(SELECT 1 FROM dbo."__EFMigrationsHistory" WHERE "MigrationId" = '20260521171625_InitialMigration') THEN
    DROP TABLE dbo."FgsSetupPricingMatrixMaterialTier";
    END IF;
END $EF$;
DO $EF$
BEGIN
    IF EXISTS(SELECT 1 FROM dbo."__EFMigrationsHistory" WHERE "MigrationId" = '20260521171625_InitialMigration') THEN
    DROP TABLE dbo."FgsSetupPricingMatrixOther";
    END IF;
END $EF$;
DO $EF$
BEGIN
...
BEGIN
    IF EXISTS(SELECT 1 FROM dbo."__EFMigrationsHistory" WHERE "MigrationId" = '20260521171625_InitialMigration') THEN
    DROP TABLE dbo."FgsSetupPricingMatrixLabor";
    END IF;
END $EF$;
DO $EF$
BEGIN
...
BEGIN
    IF EXISTS(SELECT 1 FROM dbo."__EFMigrationsHistory" WHERE "MigrationId" = '20260521171625_InitialMigration') THEN
    DROP TABLE dbo."FgsSetupPricingMatrix";
    END IF;
END $EF$;
DO $EF$
BEGIN
...
BEGIN
    IF EXISTS(SELECT 1 FROM dbo."__EFMigrationsHistory" WHERE "MigrationId" = '20260521171625_InitialMigration') THEN
    DROP TABLE dbo."GloSetupTenantStatus";
    END IF;
END $EF$;
DO $EF$
BEGIN
    ...
    WHERE "MigrationId" = '20260521171625_InitialMigration';
    END IF;
END $EF$;
COMMIT;
