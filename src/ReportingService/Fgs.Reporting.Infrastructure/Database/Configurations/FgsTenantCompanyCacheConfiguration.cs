...
namespace Fgs.Reporting.Infrastructure.Database.Configurations;
...
internal sealed class FgsTenantCompanyCacheConfiguration : IEntityTypeConfiguration<FgsTenantCompanyCache>
{
    public void Configure(EntityTypeBuilder<FgsTenantCompanyCache> entity)
    {
        entity.ToTable(
            ...
            t => t.HasComment(
                "Local cache of tenant company information used by the reporting schema to eliminate cross-schema dependencies on tenant.FgsTenantCompany."));
