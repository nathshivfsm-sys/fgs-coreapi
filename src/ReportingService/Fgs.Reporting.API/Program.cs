...
{
    options.Title = "FGS Reporting Service";
    options.Description = "Reports, dashboards, and analytics.";
...
builder.Services.AddFgsObservability(builder.Configuration, "fgs-reporting-service");
