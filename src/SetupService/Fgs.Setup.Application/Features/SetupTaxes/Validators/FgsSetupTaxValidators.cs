...
{
    public CreateFgsSetupTaxCommandValidator(IFgsSetupTaxReadRepository readRepository)
    {
...
{
    public UpdateFgsSetupTaxCommandValidator(IFgsSetupTaxReadRepository readRepository)
    {
