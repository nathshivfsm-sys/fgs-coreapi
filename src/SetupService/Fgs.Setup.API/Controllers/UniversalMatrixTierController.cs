...
/// <summary>
/// Tenant-scoped universal matrix tier catalog management.
/// </summary>
...
public sealed class UniversalMatrixTierController(IMediator mediator) : ControllerBase
{
        ...
        CancellationToken cancellationToken = default)
    {
        var response = await mediator.Send(
            new ListUniversalMatrixTiersQuery(
                ...
                new FgsUniversalMatrixTierListFilters(name, universalPricingServiceId)),
            cancellationToken);
    ...
    public async Task<IActionResult> Lookup(
        ...
        CancellationToken cancellationToken = default)
    {
        var response = await mediator.Send(new LookupUniversalMatrixTiersQuery(activeOnly, universalPricingServiceId), cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
