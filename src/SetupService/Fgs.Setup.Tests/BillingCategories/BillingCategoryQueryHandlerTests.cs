...
public sealed class BillingCategoryQueryHandlerTests
{
    ...
    {
        var detail = new BillingCategoryDetailDto(1, 10, 20, "TEST", "BillingCategoryName", "Description value", 1, false, false, true, true, DateTimeOffset.UtcNow, "seed", null, "seed");
