...
public sealed class ResolutionCodeCommandHandlerTests
{
    ...
    public async Task DeleteHandler_SoftDeletes()
    {
        ...
        var response = await deleteHandler.Handle(
            new DeleteResolutionCodeCommand(created.Data!.Id),
            CancellationToken.None);
    ...
    private static ResolutionCodeWriteService CreateWriteService(FgsSetupDbContext context)
    {
        ...
        return new ResolutionCodeWriteService(context, unitOfWork, auditHelper);
    }
