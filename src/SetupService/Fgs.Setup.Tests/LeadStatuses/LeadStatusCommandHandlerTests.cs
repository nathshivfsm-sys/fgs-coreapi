...
public sealed class LeadStatusCommandHandlerTests
{
    ...
    public async Task DeleteHandler_SoftDeletes()
    {
        ...
        var response = await deleteHandler.Handle(
            new DeleteLeadStatusCommand(created.Data!.Id),
            CancellationToken.None);
    ...
    private static LeadStatusWriteService CreateWriteService(FgsSetupDbContext context)
    {
        ...
        return new LeadStatusWriteService(context, unitOfWork, auditHelper);
    }
