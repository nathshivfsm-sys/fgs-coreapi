...
public sealed class FgsSalesActivityTypeCommandHandlerTests
{
    ...
    public async Task CreateHandler_CreatesActiveRecord()
    {
        ...
        var handler = new CreateFgsSalesActivityTypeCommandHandler(
            writeService,
            cache.Object,
            tenantAccessor,
        ...
        cache.Verify(
            c => c.RemoveByPrefixAsync(
                CacheKeys.EntityPrefix(TenantId, CompanyId, "salesactivitytype"),
    ...
    public async Task DeleteHandler_SoftDeletes()
    {
        ...
        var cache = new Mock<ICacheService>();
        var tenantAccessor = CreateTenantContextAccessor();
        var createHandler = new CreateFgsSalesActivityTypeCommandHandler(
            writeService,
            cache.Object,
            tenantAccessor,
            NullLogger<CreateFgsSalesActivityTypeCommandHandler>.Instance);
        var deleteHandler = new DeleteFgsSalesActivityTypeCommandHandler(
            writeService,
            cache.Object,
            tenantAccessor,
        ...
        var response = await deleteHandler.Handle(
            new DeleteFgsSalesActivityTypeCommand(created.Data!.Id),
            CancellationToken.None);
    ...
    private static FgsSalesActivityTypeWriteService CreateWriteService(FgsSetupDbContext context)
    {
        ...
        return new FgsSalesActivityTypeWriteService(context, unitOfWork, auditHelper);
    }
