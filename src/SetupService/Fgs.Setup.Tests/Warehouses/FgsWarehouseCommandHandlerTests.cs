...
public sealed class FgsWarehouseCommandHandlerTests
{
    ...
    public async Task CreateHandler_CreatesActiveRecord()
    {
        ...
        var response = await handler.Handle(
            new CreateFgsWarehouseCommand(new FgsWarehouseCreateDto("TEST", "Name", "WarehouseType", null, "Description value", false)),
    ...
    public async Task DeleteHandler_SoftDeletes()
    {
        ...
        var response = await deleteHandler.Handle(
            new DeleteFgsWarehouseCommand(created.Data!.Id),
            CancellationToken.None);
    ...
    private static FgsWarehouseWriteService CreateWriteService(FgsSetupDbContext context)
    {
        ...
        return new FgsWarehouseWriteService(context, unitOfWork, auditHelper);
    }
