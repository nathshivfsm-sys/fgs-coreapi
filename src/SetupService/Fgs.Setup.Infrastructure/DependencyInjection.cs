...
using Fgs.Setup.Infrastructure.Persistence.GloLookups;
...
public static class DependencyInjection
{
        ...
        ConfigurationManager configuration)
    {
        ...
        services.AddScoped<IGloCountryReadRepository, GloCountryReadRepository>();
        services.AddScoped<IGloStateProvinceReadRepository, GloStateProvinceReadRepository>();
        services.AddScoped<IGloTimeZoneReadRepository, GloTimeZoneReadRepository>();
        services.AddScoped<IGloLanguageReadRepository, GloLanguageReadRepository>();
        services.AddScoped<IGloLocationTypeReadRepository, GloLocationTypeReadRepository>();
        services.AddScoped<IGloBusinessTypeReadRepository, GloBusinessTypeReadRepository>();
        services.AddScoped<IGloSetupDescriptionTypeReadRepository, GloSetupDescriptionTypeReadRepository>();
        services.AddScoped<IGloMasterEntityTypeReadRepository, GloMasterEntityTypeReadRepository>();
        services.AddScoped<IGloUnitOfMeasureReadRepository, GloUnitOfMeasureReadRepository>();
        services.AddScoped<IGloInventoryTransactionSourceTypeReadRepository, GloInventoryTransactionSourceTypeReadRepository>();
        services.AddScoped<IGloInventoryTransactionTypeReadRepository, GloInventoryTransactionTypeReadRepository>();
