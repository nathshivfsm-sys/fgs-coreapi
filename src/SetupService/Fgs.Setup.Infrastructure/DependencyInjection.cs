...
using Fgs.Setup.Infrastructure.Entities.TechTrades;
using Fgs.Setup.Infrastructure.Entities.TitlesOfCourtesy;
...
using Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixAddOns;
using Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixFrequencyDiscounts;
using Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixItems;
using Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixOneTimeFees;
using Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixSizeTiers;
using Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixTiers;
using Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalPricingServices;
...
using Fgs.Setup.Infrastructure.Entities.SalesActivityOutcomes;
using Fgs.Setup.Infrastructure.Entities.SalesActivityTypes;
using Fgs.Setup.Infrastructure.Entities.SalesDispositionReasons;
using Fgs.Setup.Infrastructure.Entities.SalesPipelineStatuses;
using Fgs.Setup.Infrastructure.Entities.SetupDescriptions;
using Fgs.Setup.Infrastructure.Entities.SetupLaborRateTypes;
using Fgs.Setup.Infrastructure.Entities.SetupPaymentMethods;
using Fgs.Setup.Infrastructure.Entities.SetupPaymentTerms;
using Fgs.Setup.Infrastructure.Entities.SetupPostalCodes;
using Fgs.Setup.Infrastructure.Entities.SetupPricingMatrices;
using Fgs.Setup.Infrastructure.Entities.SetupTaxAuthorities;
using Fgs.Setup.Infrastructure.Entities.SetupTaxes;
using Fgs.Setup.Infrastructure.Entities.SetupTechSkillLevels;
using Fgs.Setup.Infrastructure.Entities.SetupTimeSlots;
using Fgs.Setup.Infrastructure.Entities.SetupZones;
using Fgs.Setup.Infrastructure.Entities.Tags;
using Fgs.Setup.Infrastructure.Entities.VehicleMaintenances;
using Fgs.Setup.Infrastructure.Entities.Vehicles;
...
using Fgs.Setup.Infrastructure.Entities.BillingCategories;
using Fgs.Setup.Infrastructure.Entities.FgsBusinessTypes;
using Fgs.Setup.Infrastructure.Entities.JobTypeCategories;
using Fgs.Setup.Infrastructure.Entities.JobTypeSubCategories;
using Fgs.Setup.Infrastructure.Entities.JobTypes;
using Fgs.Setup.Infrastructure.Entities.LeadDisqualificationReasons;
using Fgs.Setup.Infrastructure.Entities.LeadSources;
using Fgs.Setup.Infrastructure.Entities.LeadStatuses;
using Fgs.Setup.Infrastructure.Entities.ResolutionCodes;
