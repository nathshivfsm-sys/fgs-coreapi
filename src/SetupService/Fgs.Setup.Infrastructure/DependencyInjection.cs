...
public static class DependencyInjection
{
        ...
        ConfigurationManager configuration)
    {
        ...
        services.AddScoped<IFgsSetupTaxDetailReadRepository, FgsSetupTaxDetailReadRepository>();
        services.AddScoped<IFgsSetupTaxDetailWriteService, FgsSetupTaxDetailWriteService>();
