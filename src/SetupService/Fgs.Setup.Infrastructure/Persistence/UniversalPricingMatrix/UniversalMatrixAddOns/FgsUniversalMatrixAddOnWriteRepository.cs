...
public sealed class FgsUniversalMatrixAddOnWriteRepository : IFgsUniversalMatrixAddOnWriteRepository
{
    private readonly FgsSetupDbContext _context;
    private readonly IUnitOfWork _unitOfWork;
    private readonly SetupEntityAuditHelper _auditHelper;

    public FgsUniversalMatrixAddOnWriteRepository(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            UniversalPricingServiceId = dto.UniversalPricingServiceId, Name = dto.Name.Trim(), UnitType = dto.UnitType.Trim(), Price = dto.Price, DisplayOrder = dto.DisplayOrder
        };
    ...
    private async Task SaveChangesAsync(CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("A universal matrix add-on with the same type and name already exists.", ex);
        }
    }
