...
internal class FgsLocationConfiguration : IEntityTypeConfiguration<FgsLocation>
{
    public void Configure(EntityTypeBuilder<FgsLocation> entity)
    {
        entity.ToTable(
            "FgsLocation",
            t => t.HasComment("Reusable address and geo location rows scoped to a tenant company."));
        ...
        entity.Property(e => e.MasterEntityTypeId).HasColumnOrder(3);
        entity.Property(e => e.EntityNumber).HasColumnOrder(4);
