...
internal class SetupOutboxMessageConfiguration : IEntityTypeConfiguration<SetupOutboxMessage>
{
    public void Configure(EntityTypeBuilder<SetupOutboxMessage> entity)
    {
        entity.ToTable("SetupOutboxMessage");
