...
namespace Fgs.Setup.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260926191753_AddFgsJobTypeTaskSubCategoryName")]
    partial class AddFgsJobTypeTaskSubCategoryName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsCrew", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("FgsCrew", "setup", t =>
                        {
                            t.HasComment("Stores technician crew definitions used for dispatching and scheduling.");
                        });
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsCrewMember", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long>("CrewId")
                        .HasColumnType("bigint")
                        .HasComment("Crew to which the technician belongs.");
                    ...
                    b.Property<long>("TechnicianProfileId")
                        .HasColumnType("bigint")
                        .HasComment("Technician profile assigned to the crew.");
                    ...
                    b.HasIndex("TenantId", "CompanyId", "TechnicianProfileId")
                        .IsUnique()
                        .HasDatabaseName("UX_FgsCrewMember_TenantId_CompanyId_TechnicianProfileId");

                    b.ToTable("FgsCrewMember", "setup", t =>
                        {
                            t.HasComment("Stores permanent technician membership within crews.");
                        });
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsEmployee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasComment("Primary key identifier for the employee record.");
                    ...
                    b.Property<DateOnly?>("BirthDate")
                        .HasColumnType("date")
                        .HasComment("Employee date of birth.");

                    b.Property<long>("CompanyId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(2)
                        .HasComment("Identifier of the company that owns the employee record.");
                    ...
                    b.Property<long>("TenantId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(1)
                        .HasComment("Identifier of the tenant that owns the employee record.");

                    b.Property<DateOnly?>("TerminationDate")
                        .HasColumnType("date")
                        .HasComment("Date employee was terminated or separated from employment.");
                    ...
                    b.HasIndex("TenantId", "CompanyId", "EmployeeTypeId")
                        .HasDatabaseName("IX_FgsEmployee_TenantId_CompanyId_EmployeeTypeId");

                    b.HasIndex("TenantId", "CompanyId", "StatusId")
                        .HasDatabaseName("IX_FgsEmployee_TenantId_CompanyId_StatusId");

                    b.ToTable("FgsEmployee", "setup", t =>
                        {
                            t.HasComment("Stores employee master information for office and field personnel. Employees may optionally be linked to a system user account through UserId. Technician-specific operational settings are stored in FgsEmployeeTechnicianProfile.");
                        });
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsEmployeeTechnicianProfile", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .HasComment("Primary key identifier for the technician profile.");
                    ...
                    b.Property<long>("CompanyId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(2)
                        .HasComment("Identifier of the company that owns the technician profile.");
                    ...
                    b.Property<long?>("DispatchZoneId")
                        .HasColumnType("bigint")
                    ...
                    b.Property<short>("StartLocationTypeId")
                        .HasColumnType("smallint")
                    ...
                    b.Property<long>("TenantId")
                        .HasColumnType("bigint")
                        .HasColumnOrder(1)
                        .HasComment("Identifier of the tenant that owns the technician profile.");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_FgsEmployeeTechnicianProfile");
                    ...
                    b.HasIndex("TenantId", "CompanyId", "CanBeScheduled")
                        .HasDatabaseName("IX_FgsEmployeeTechnicianProfile_TenantId_CompanyId_CanBeScheduled");

                    b.HasIndex("TenantId", "CompanyId", "DispatchZoneId")
                    ...
                    b.HasIndex("TenantId", "CompanyId", "TechTradeId")
                        .HasDatabaseName("IX_FgsEmployeeTechnicianProfile_TenantId_CompanyId_TechTradeId");

                    b.ToTable("FgsEmployeeTechnicianProfile", "setup", t =>
                        {
                            t.HasComment("Stores technician-specific operational settings used by dispatching, scheduling, routing, capacity planning, inventory assignment, and customer-facing technician communications.");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsJobTypeTask", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CompanyId", "JobTypeCategoryId", "Name")
                        .IsUnique()
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsLocation", b =>
                {
                    ...
                    b.ToTable("FgsLocation", "setup", t =>
                        {
                            t.HasComment("Reusable address and geo location rows scoped to a tenant company.");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsPriceBook", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CompanyId", "PriceBookCode")
                        .IsUnique()
                        .HasDatabaseName("UX_FgsPriceBook_Tenant_Company_PriceBookCode");

                    b.ToTable("FgsPriceBook", "setup", t =>
                        {
                            t.HasComment("Defines the master catalog of services offered by a company. Each price book header represents a reusable service template used by estimates, work orders, invoices, scheduling, and pricing.");

                            t.HasCheckConstraint("CK_FgsPriceBook_PricingModel", "\"PricingModel\" IN ('Flat Rate', 'Dynamic')");
                        });
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsPriceBookItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("TenantId", "CompanyId", "PriceBookId")
                        .HasDatabaseName("IX_FgsPriceBookItem_TenantId_CompanyId_PriceBookId");

                    b.ToTable("FgsPriceBookItem", "setup", t =>
                        {
                            t.HasComment("Defines the inventory, non-inventory, and free-form items that make up a price book service.");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsSetupPricingMatrixLabor", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CompanyId", "PricingMatrixId", "LaborRateTypeId", "TechSkillLevelId")
                        .IsUnique()
                    ...
                    b.ToTable("FgsSetupPricingMatrixOther", "setup", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_FgsSetupPricingMatrixOther_AdjustmentValue", "\"AdjustmentValue\" IS NULL OR \"AdjustmentValue\" >= 0");
                    ...
                    b.ToTable("FgsSetupTaxAuthority", "setup", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_FgsSetupTaxAuthority_TaxPercent", "\"TaxPercent\" >= 0 AND \"TaxPercent\" <= 100");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsSetupTimeSlot", b =>
                {
                    ...
                    b.Property<bool>("IncludeInCapacityPlanning")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasComment("Indicates whether this time slot is considered during capacity planning and scheduling calculations. When false, the time slot is excluded from capacity planning.");
                    ...
                    b.Property<bool>("ShowToExternalSystem")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasComment("Indicates whether this time slot is exposed to third-party integrations and external systems. When false, the time slot remains internal to the application.");
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsVehicle", b =>
                {
                    ...
                    b.HasAlternateKey("InventoryLocationId")
                        .HasName("UQ_FgsVehicle_InventoryLocationId");

                    b.HasIndex("TenantId", "CompanyId", "InventoryLocationId")
                    ...
                    b.ToTable("FgsVehicle", "setup", t =>
                        {
                            t.HasComment("Stores company-owned or leased vehicles used for field service operations. Each vehicle is associated with an inventory location that serves as a truck storage location.");
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloEstimateFlavor", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
                    ...
                    b.HasIndex("FlavorCode")
                        .IsUnique()
                        .HasDatabaseName("UX_GloEstimateFlavor_FlavorCode");

                    b.ToTable("GloEstimateFlavor", "glo");
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloEstimateStatus", b =>
                {
                    b.Property<short>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smallint");
                    ...
                    b.ToTable("GloEstimateStatus", "glo", t =>
                        {
                            t.HasComment("Stores system-defined estimate statuses used to seed tenant/company estimate statuses during provisioning.");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloInventoryCategory", b =>
                {
                    ...
                    b.ToTable("GloInventoryCategory", "glo", t =>
                        {
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloInventoryItemType", b =>
                {
                    ...
                    b.ToTable("GloInventoryItemType", "glo", t =>
                        {
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloInventorySubCategory", b =>
                {
                    ...
                    b.ToTable("GloInventorySubCategory", "glo", t =>
                        {
                            t.HasComment("Global inventory sub-category catalog scoped to an inventory category.");
                        });
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloInventoryTransactionSourceType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasKey("Id")
                        .HasName("PK_GloInventoryTransactionSourceType");

                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("UQ_GloInventoryTransactionSourceType_Code");

                    b.ToTable("GloInventoryTransactionSourceType", "glo", t =>
                        {
                            t.HasComment("Defines business processes and source documents that generate inventory transactions.");
                        });
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloInventoryTransactionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("InventoryTransactionSourceTypeId")
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("PK_GloInventoryTransactionType");

                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("UQ_GloInventoryTransactionType_Code");

                    b.HasIndex("InventoryTransactionSourceTypeId")
                        .HasDatabaseName("IX_GloInventoryTransactionType_SourceType");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("IX_GloInventoryTransactionType_IsActive");

                    b.ToTable("GloInventoryTransactionType", "glo", t =>
                        {
                            t.HasComment("Defines specific inventory ledger transactions generated by inventory business processes.");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloPermission", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("PermissionCode")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasComment("Unique system identifier for the permission. Used internally by the application and should not be changed after creation.");

                    b.HasKey("Id");

                    b.HasAlternateKey("PermissionCode")
                        .HasName("UX_GloPermission_PermissionCode");

                    b.HasIndex("Name")
                        .HasDatabaseName("IX_GloPermission_Name");

                    b.ToTable("GloPermission", "glo", t =>
                        {
                            t.HasComment("Global catalog of permissions supported by the FGS platform. Permissions define the actions that can be assigned to security roles.");

                            t.HasCheckConstraint("CK_GloPermission_Name_NotEmpty", "length(trim(\"Name\")) > 0");

                            t.HasCheckConstraint("CK_GloPermission_PermissionCode_NotEmpty", "length(trim(\"PermissionCode\")) > 0");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloRolePermission", b =>
                {
                    b.Property<short>("RoleId")
                        .HasColumnType("smallint")
                    ...
                    b.Property<bool>("IsActive")
                        ...
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasComment("Indicates whether this default role-to-permission assignment is active and should be included when seeding tenant role permission assignments.");

                    b.HasKey("RoleId", "PermissionId");

                    b.HasIndex("PermissionId")
                        .HasDatabaseName("IX_GloRolePermission_PermissionId");

                    b.ToTable("GloRolePermission", "glo", t =>
                        {
                            t.HasComment("Global default mapping of standard roles to permissions used to seed tenant role permission assignments during onboarding.");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloTimeZone", b =>
                {
                    ...
                    b.Property<string>("TimeZoneCode")
                        ...
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasComment("Short time zone abbreviation used by the application, such as EST, CST, MST, or PST.");
                    ...
                    b.ToTable("GloTimeZone", "glo", t =>
                        {
                            t.HasComment("Global reference table containing time zone options available for customer and user selection.");
                        });
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsCrew", b =>
                {
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsTenantCompanyCache", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_FgsCrew_FgsTenantCompanyCache_TenantId_CompanyId");
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsCrewMember", b =>
                {
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsCrew", null)
                        .WithMany()
                    ...
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsEmployeeTechnicianProfile", null)
                        .WithMany()
                    ...
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsTenantCompanyCache", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_FgsCrewMember_FgsTenantCompanyCache_TenantId_CompanyId");
                });
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsEmployee", b =>
                {
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsTenantCompanyCache", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_FgsEmployee_FgsTenantCompanyCache_TenantId_CompanyId");
                });

            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsEmployeeTechnicianProfile", b =>
                {
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsEmployee", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsJobTypeTask", b =>
                {
                    ...
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsSetupTechSkillLevel", "SkillLevel")
                        .WithMany()
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsPriceBook", b =>
                {
                    ...
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsTenantCompanyCache", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_FgsPriceBook_FgsTenantCompanyCache_TenantId_CompanyId");
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.FgsPriceBookItem", b =>
                {
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsPriceBook", "PriceBook")
                        .WithMany("Items")
                    ...
                    b.HasOne("Fgs.Setup.Domain.Entities.FgsTenantCompanyCache", null)
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_FgsPriceBookItem_FgsTenantCompanyCache_TenantId_CompanyId");
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloInventoryTransactionType", b =>
                {
                    b.HasOne("Fgs.Setup.Domain.Entities.GloInventoryTransactionSourceType", null)
                        .WithMany()
                        .HasForeignKey("InventoryTransactionSourceTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("Fgs.Setup.Domain.Entities.GloRolePermission", b =>
                {
                    b.HasOne("Fgs.Setup.Domain.Entities.GloPermission", "Permission")
                        .WithMany()
