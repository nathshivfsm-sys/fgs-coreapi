    ...
    VALUES
        (
            ...
            '[
                ...
                {"key":"FgsAssetReadOnly","label":"Asset Service Read-Only (FgsAssetReadOnly)","type":"password","required":false,"sensitive":true},
...
INNER JOIN (
    VALUES
        ...
        -- TENANT_FgsTenantCompany_asset_cache -> FgsTenantCompanyCache
        ('TENANT_FgsTenantCompany_asset_cache', NULL, 'TenantId', 'TENANT_ID', NULL, 1, true, true),
        ('TENANT_FgsTenantCompany_asset_cache', 'CompanyNumber', 'CompanyId', NULL, NULL, 2, true, true),
        ('TENANT_FgsTenantCompany_asset_cache', 'CompanyGuid', 'CompanyGuid', NULL, NULL, 3, true, true),
        ('TENANT_FgsTenantCompany_asset_cache', 'Code', 'CompanyCode', NULL, NULL, 4, true, true),
        ('TENANT_FgsTenantCompany_asset_cache', 'Name', 'CompanyName', NULL, NULL, 5, true, true),
        ('TENANT_FgsTenantCompany_asset_cache', 'IsActive', 'IsActive', NULL, NULL, 6, true, true),
        ('TENANT_FgsTenantCompany_asset_cache', NULL, 'UpdatedOn', 'CURRENT_TIMESTAMP', NULL, 7, true, true),

        -- TENANT_FgsTenantCompany_svc_cache -> FgsTenantCompanyCache
        ('TENANT_FgsTenantCompany_svc_cache', NULL, 'TenantId', 'TENANT_ID', NULL, 1, true, true),
        ('TENANT_FgsTenantCompany_svc_cache', 'CompanyNumber', 'CompanyId', NULL, NULL, 2, true, true),
        ('TENANT_FgsTenantCompany_svc_cache', 'CompanyGuid', 'CompanyGuid', NULL, NULL, 3, true, true),
        ('TENANT_FgsTenantCompany_svc_cache', 'Code', 'CompanyCode', NULL, NULL, 4, true, true),
        ('TENANT_FgsTenantCompany_svc_cache', 'Name', 'CompanyName', NULL, NULL, 5, true, true),
        ('TENANT_FgsTenantCompany_svc_cache', 'IsActive', 'IsActive', NULL, NULL, 6, true, true),
        ('TENANT_FgsTenantCompany_svc_cache', NULL, 'UpdatedOn', 'CURRENT_TIMESTAMP', NULL, 7, true, true),

        -- TENANT_CrmServiceLocation_asset_cache -> FgsServiceLocationCache
        ('TENANT_CrmServiceLocation_asset_cache', NULL, 'TenantId', 'TENANT_ID', NULL, 1, true, true),
        ('TENANT_CrmServiceLocation_asset_cache', NULL, 'CompanyId', 'COMPANY_ID', NULL, 2, true, true),
        ('TENANT_CrmServiceLocation_asset_cache', 'Id', 'ServiceLocationId', NULL, NULL, 3, true, true),
        ('TENANT_CrmServiceLocation_asset_cache', 'CustomerId', 'CustomerId', NULL, NULL, 4, true, true),
