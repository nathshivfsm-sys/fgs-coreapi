...
namespace Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixSizeTiers;

public sealed class FgsUniversalMatrixSizeTierWriteRepository : IFgsUniversalMatrixSizeTierWriteRepository
{
    private readonly FgsSetupDbContext _context;
    private readonly IUnitOfWork _unitOfWork;
    private readonly SetupEntityAuditHelper _auditHelper;

    public FgsUniversalMatrixSizeTierWriteRepository(
    ...
    private async Task SaveChangesAsync(CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("A universal matrix size tier with the same type and name already exists.", ex);
        }
    }
