...
namespace Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixFrequencyDiscounts;

public sealed class FgsUniversalMatrixFrequencyDiscountWriteRepository : IFgsUniversalMatrixFrequencyDiscountWriteRepository
{
    private readonly FgsSetupDbContext _context;
    private readonly IUnitOfWork _unitOfWork;
    private readonly SetupEntityAuditHelper _auditHelper;

    public FgsUniversalMatrixFrequencyDiscountWriteRepository(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            UniversalPricingServiceId = dto.UniversalPricingServiceId, Name = dto.Name.Trim(), DiscountPercent = dto.DiscountPercent, DisplayOrder = dto.DisplayOrder
        };
    ...
    private async Task SaveChangesAsync(CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("A universal matrix frequency discount with the same type and name already exists.", ex);
        }
    }
