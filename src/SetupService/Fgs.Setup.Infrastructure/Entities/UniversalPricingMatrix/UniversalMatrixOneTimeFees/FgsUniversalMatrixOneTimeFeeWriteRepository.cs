...
namespace Fgs.Setup.Infrastructure.Entities.UniversalPricingMatrix.UniversalMatrixOneTimeFees;

public sealed class FgsUniversalMatrixOneTimeFeeWriteRepository : IFgsUniversalMatrixOneTimeFeeWriteRepository
{
    private readonly FgsSetupDbContext _context;
    private readonly IUnitOfWork _unitOfWork;
    private readonly SetupEntityAuditHelper _auditHelper;

    public FgsUniversalMatrixOneTimeFeeWriteRepository(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            UniversalPricingServiceId = dto.UniversalPricingServiceId, Name = dto.Name.Trim(), Amount = dto.Amount, DisplayOrder = dto.DisplayOrder
        };
    ...
    private async Task SaveChangesAsync(CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException("A universal matrix one-time fee with the same type and name already exists.", ex);
        }
    }
