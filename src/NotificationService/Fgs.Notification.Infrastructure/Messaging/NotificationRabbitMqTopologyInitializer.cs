...
namespace Fgs.Notification.Infrastructure.Messaging;

public sealed class NotificationRabbitMqTopologyInitializer(
    IOptionsMonitor<RabbitMqOptions> options,
    ILogger<NotificationRabbitMqTopologyInitializer> logger)
{
