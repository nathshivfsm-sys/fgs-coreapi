...
{
    /// <inheritdoc />
    public partial class AddCrmOutboxMessage : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrmOutboxMessage", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_CrmOutboxMessage_CorrelationId",
                schema: "crm",
                table: "CrmOutboxMessage",
                column: "CorrelationId");

            migrationBuilder.CreateIndex(
                name: "IX_CrmOutboxMessage_EventType",
                schema: "crm",
                table: "CrmOutboxMessage",
                column: "EventType");

            migrationBuilder.CreateIndex(
                name: "IX_CrmOutboxMessage_Status_NextRetryOn",
                schema: "crm",
                table: "CrmOutboxMessage",
                columns: new[] { "Status", "NextRetryOn" });

            migrationBuilder.CreateIndex(
                name: "IX_CrmOutboxMessage_TenantId",
                schema: "crm",
                table: "CrmOutboxMessage",
                column: "TenantId");
        }
