...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    ALTER TABLE crm."FgsEstimate" ADD COLUMN IF NOT EXISTS "RecommendedByEmployeeId" bigint;
    COMMENT ON COLUMN crm."FgsEstimate"."RecommendedByEmployeeId" IS 'Stores the employee ID of the employee who recommended the estimate or proposed work to the customer.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    ALTER TABLE crm."FgsEstimate" ADD COLUMN IF NOT EXISTS "VerificationRequired" boolean NOT NULL DEFAULT false;
    COMMENT ON COLUMN crm."FgsEstimate"."VerificationRequired" IS 'Indicates whether the estimate requires internal verification before it can proceed through the estimate workflow.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    ALTER TABLE crm."FgsEstimate" ADD COLUMN IF NOT EXISTS "VerifiedByEmployeeId" bigint;
    COMMENT ON COLUMN crm."FgsEstimate"."VerifiedByEmployeeId" IS 'Stores the employee ID of the employee who reviewed and verified the estimate.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    ALTER TABLE crm."FgsEstimate" ADD COLUMN IF NOT EXISTS "VerifiedOn" timestamptz;
    COMMENT ON COLUMN crm."FgsEstimate"."VerifiedOn" IS 'Stores the date and time when the estimate was verified.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    ALTER TABLE crm."FgsEstimate" RENAME COLUMN "QuoteName" TO "EstimateName";
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    ALTER TABLE crm."FgsEstimate" ADD COLUMN IF NOT EXISTS "InternalNotes" text;
    COMMENT ON COLUMN crm."FgsEstimate"."InternalNotes" IS 'Stores internal notes related to the estimate. This information is intended for internal company use and should not be displayed to the customer.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    ALTER TABLE crm."FgsEstimate" ADD COLUMN IF NOT EXISTS "InstallationDescription" text;
    COMMENT ON COLUMN crm."FgsEstimate"."InstallationDescription" IS 'Stores installation instructions, installation scope details, or other information intended for the installation or field service team.';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    ALTER TABLE crm."FgsEstimate" RENAME COLUMN "QuoteDescription" TO "EstimateDescription";
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM crm."__EFMigrationsHistory" WHERE "MigrationId" = '20260704151227_UpdateFgsEstimateVerificationAndNaming') THEN
    INSERT INTO crm."__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260704151227_UpdateFgsEstimateVerificationAndNaming', '10.0.8');
    END IF;
END $EF$;
COMMIT;
