...
{
    options.Title = "FGS Job Service";
    options.Description = "Job lifecycle, dispatch, and field service operations.";
...
builder.Services.AddFgsObservability(builder.Configuration, "fgs-job-service");
