...
namespace Fgs.Dispatch.Infrastructure.Database.Configurations;
...
internal sealed class FgsTenantCompanyCacheConfiguration : IEntityTypeConfiguration<FgsTenantCompanyCache>
{
    public void Configure(EntityTypeBuilder<FgsTenantCompanyCache> entity)
    {
        entity.ToTable(
            ...
            t => t.HasComment(
                "Local cache of tenant company information used by the Dispatch schema to eliminate cross-schema dependencies on tenant.FgsTenantCompany."));
