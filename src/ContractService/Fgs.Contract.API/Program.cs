...
{
    options.Title = "FGS Contract Service";
    options.Description = "Contracts and service agreements.";
...
builder.Services.AddFgsObservability(builder.Configuration, "fgs-contract-service");
